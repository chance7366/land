...
import { NewsPaginationSampleClient } from "@/components/mockup/NewsPaginationSampleClient";

export const metadata: Metadata = {
  title: "디자인 목업 | 소식 페이지네이션",
  robots: { index: false, follow: false },
};

export default function NewsPaginationMockupPage() {
  return (
    <LandingShell>
